...
{
    /// <summary>
    /// Configuration with validation parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Procedural Planet Config 14")]
    public sealed class ProceduralPlanetConfig14 : ScriptableObject
    {
        [Header("Planet")]
        ...
        /// <summary>
        /// Generate validated mesh from config.
        /// </summary>
        public Mesh GenerateMesh()
        {
            ...
            var mesh = new Mesh { name = $"{planetName}_Validated" };
