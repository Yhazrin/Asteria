...
{
    /// <summary>
    /// Configuration with stitching parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Procedural Planet Config 21")]
    public sealed class ProceduralPlanetConfig21 : ScriptableObject
    {
        [Header("Planet")]
        ...
        public Mesh GenerateMesh()
        {
            ...
            var mesh = new Mesh { name = $"{planetName}_Stitched" };
