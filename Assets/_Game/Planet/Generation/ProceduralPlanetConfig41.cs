...
{
    /// <summary>
    /// Configuration with ripple parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Procedural Planet Config 41")]
    public sealed class ProceduralPlanetConfig41 : ScriptableObject
    {
        [Header("Planet")]
        ...
        public float rippleAmount = 0.1f;
        public float rippleFrequency = 0.5f;
        ...
        public Mesh GenerateMesh()
        {
            ...
            var mesh = new Mesh { name = $"{planetName}_Ripple" };
