...
{
    /// <summary>
    /// Configuration with bounds parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Procedural Planet Config 29")]
    public sealed class ProceduralPlanetConfig29 : ScriptableObject
    {
        [Header("Planet")]
        ...
        public Mesh GenerateMesh()
        {
            ...
            var mesh = new Mesh { name = $"{planetName}_Bounds" };
