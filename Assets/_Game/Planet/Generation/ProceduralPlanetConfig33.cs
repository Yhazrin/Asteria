...
namespace Asteria.Planet.Generation
{
    ...
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Procedural Planet Config 33")]
    public sealed class ProceduralPlanetConfig33 : ScriptableObject
    {
        [Header("Planet")]
        ...
        public Mesh GenerateMesh()
        {
            ...
            var mesh = new Mesh { name = $"{planetName}_Smoothed" };
