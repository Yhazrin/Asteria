...
{
    /// <summary>
    /// Configuration with reversal parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Procedural Planet Config 25")]
    public sealed class ProceduralPlanetConfig25 : ScriptableObject
    {
        [Header("Planet")]
        ...
        public Mesh GenerateMesh()
        {
            ...
            var mesh = new Mesh { name = $"{planetName}_Reversed" };
