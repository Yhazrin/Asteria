...
{
    /// <summary>
    /// Planet generator with procedural normals.
    /// </summary>
    public sealed class ProceduralPlanetGenerator17 : MonoBehaviour
    {
        [Header("Settings")]
        ...
        /// <summary>
        /// Generate mesh with procedural normals.
        /// </summary>
        public Mesh GenerateMeshWithProceduralNormals()
        {
        ...
        Mesh GenerateMesh()
        {
            ...
            var mesh = new Mesh { name = "PlanetProceduralNormals" };
