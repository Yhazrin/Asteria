...
{
    /// <summary>
    /// Configuration with LOD parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Procedural Planet Config 6")]
    public sealed class ProceduralPlanetConfig6 : ScriptableObject
    {
        [Header("Planet")]
