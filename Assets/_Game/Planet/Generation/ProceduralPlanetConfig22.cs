...
{
    /// <summary>
    /// Configuration with merging parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Procedural Planet Config 22")]
    public sealed class ProceduralPlanetConfig22 : ScriptableObject
    {
        [Header("Planet")]
        ...
        public Mesh GenerateMesh()
        {
            ...
            var mesh = new Mesh { name = $"{planetName}_Merged" };
