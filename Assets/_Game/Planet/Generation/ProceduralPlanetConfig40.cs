...
{
    /// <summary>
    /// Configuration with pulsing parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Procedural Planet Config 40")]
    public sealed class ProceduralPlanetConfig40 : ScriptableObject
    {
        [Header("Planet")]
        ...
        public Mesh GenerateMesh()
        {
            ...
            var mesh = new Mesh { name = $"{planetName}_Pulsing" };
