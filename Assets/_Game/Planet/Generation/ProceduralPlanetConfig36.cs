...
{
    /// <summary>
    /// Configuration with flattening parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Procedural Planet Config 36")]
    public sealed class ProceduralPlanetConfig36 : ScriptableObject
    {
        [Header("Planet")]
        ...
        public float flattenFactor = 0.5f;
        public Vector3 flattenAxis = Vector3.up;
        ...
        public Mesh GenerateMesh()
        {
            ...
            for (int lat = 0; lat <= resolution; lat++)
            {
                ...
                for (int lon = 0; lon <= resolution; lon++)
                {
                    ...
                    // Apply flattening
                    float dot = Vector3.Dot(dir, flattenAxis);
                    dir -= flattenAxis * dot * flattenFactor;
                    dir = dir.normalized;
            ...
            var mesh = new Mesh { name = $"{planetName}_Flattened" };
