...
{
    /// <summary>
    /// Configuration with translation parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Procedural Planet Config 30")]
    public sealed class ProceduralPlanetConfig30 : ScriptableObject
    {
        [Header("Planet")]
        ...
        public Mesh GenerateMesh()
        {
            ...
            for (int lat = 0; lat <= resolution; lat++)
            {
                ...
                for (int lon = 0; lon <= resolution; lon++)
                {
                    ...
                    vertices[idx] = dir * planetRadius * meshScale + meshOffset;
                    normals[idx] = dir;
            ...
            var mesh = new Mesh { name = $"{planetName}_Translated" };
