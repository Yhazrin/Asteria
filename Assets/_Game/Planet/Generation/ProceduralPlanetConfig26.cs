...
{
    /// <summary>
    /// Configuration with normal flipping parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Procedural Planet Config 26")]
    public sealed class ProceduralPlanetConfig26 : ScriptableObject
    {
        [Header("Planet")]
        ...
        public Mesh GenerateMesh()
        {
            ...
            for (int lat = 0; lat <= resolution; lat++)
            {
                ...
                for (int lon = 0; lon <= resolution; lon++)
                {
                    ...
                    normals[idx] = flipNormals ? -dir : dir;
            ...
            var mesh = new Mesh { name = $"{planetName}_Flipped" };
