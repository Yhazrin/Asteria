...
{
    /// <summary>
    /// Configuration with instancing parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Procedural Planet Config 16")]
    public sealed class ProceduralPlanetConfig16 : ScriptableObject
    {
        [Header("Planet")]
        ...
        /// <summary>
        /// Generate instanced mesh from config.
        /// </summary>
        public Mesh GenerateMesh()
        {
            ...
            var mesh = new Mesh { name = $"{planetName}_Instanced" };
