...
{
    /// <summary>
    /// Configuration with normal generation parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Procedural Planet Config 17")]
    public sealed class ProceduralPlanetConfig17 : ScriptableObject
    {
        [Header("Planet")]
        ...
        /// <summary>
        /// Generate mesh with normals from config.
        /// </summary>
        public Mesh GenerateMesh()
        {
            ...
            var mesh = new Mesh { name = $"{planetName}_Normals" };
