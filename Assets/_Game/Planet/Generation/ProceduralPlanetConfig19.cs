...
namespace Asteria.Planet.Generation
{
    ...
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Procedural Planet Config 19")]
    public sealed class ProceduralPlanetConfig19 : ScriptableObject
    {
        [Header("Planet")]
        ...
        public bool analyzeMesh = true;
        public float meshScale = 1f;

        /// <summary>
        /// Generate and analyze mesh from config.
        /// </summary>
        public (Mesh mesh, string analysis) GenerateAndAnalyze()
        {
            var mesh = GenerateMesh();

            string analysis = $"Vertices: {mesh.vertexCount}, Triangles: {mesh.triangles.Length / 3}";
        ...
        Mesh GenerateMesh()
        {
            ...
            var mesh = new Mesh { name = $"{planetName}_Analyzed" };
