...
{
    /// <summary>
    /// Configuration with statistics parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Procedural Planet Config 28")]
    public sealed class ProceduralPlanetConfig28 : ScriptableObject
    {
        [Header("Planet")]
        ...
        public Mesh GenerateMesh()
        {
            ...
            var mesh = new Mesh { name = $"{planetName}_Stats" };
