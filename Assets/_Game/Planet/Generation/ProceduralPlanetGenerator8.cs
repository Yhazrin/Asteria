...
{
    /// <summary>
    /// Planet generator with procedural UVs.
    /// </summary>
    public sealed class ProceduralPlanetGenerator8 : MonoBehaviour
    {
        [Header("Settings")]
        ...
        /// <summary>
        /// Generate mesh with procedural UVs.
        /// </summary>
        public Mesh GenerateMeshWithUVs()
        {
            ...
            for (int lat = 0; lat <= resolution; lat++)
            {
                ...
                for (int lon = 0; lon <= resolution; lon++)
                {
                    ...
                    // Procedural UV based on spherical coordinates
                    float u = theta / (Mathf.PI * 2f);
            ...
            var mesh = new Mesh { name = "PlanetUVs" };
