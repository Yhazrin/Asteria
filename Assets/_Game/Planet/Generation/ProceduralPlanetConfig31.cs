...
{
    /// <summary>
    /// Configuration with inversion parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Procedural Planet Config 31")]
    public sealed class ProceduralPlanetConfig31 : ScriptableObject
    {
        [Header("Planet")]
        ...
        public bool invertWinding = false;
        ...
        public Mesh GenerateMesh()
        {
            ...
            for (int lat = 0; lat <= resolution; lat++)
            {
                ...
                for (int lon = 0; lon <= resolution; lon++)
                {
                    ...
                    normals[idx] = invertNormals ? -dir : dir;
            ...
            var mesh = new Mesh { name = $"{planetName}_Inverted" };
