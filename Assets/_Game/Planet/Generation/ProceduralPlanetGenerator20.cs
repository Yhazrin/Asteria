...
{
    /// <summary>
    /// Planet generator with mesh decimation.
    /// </summary>
    public sealed class ProceduralPlanetGenerator20 : MonoBehaviour
    {
        [Header("Settings")]
        [SerializeField] float planetRadius = 300f;
        [SerializeField] int seed = 42;
        [SerializeField] int resolution = 128;
        [SerializeField] float decimationFactor = 0.5f;
        ...
        Mesh GenerateMesh(int res)
        {
            ...
            var mesh = new Mesh { name = $"Planet_Decimated_{res}" };
