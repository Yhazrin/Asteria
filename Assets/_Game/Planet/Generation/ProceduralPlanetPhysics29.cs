...
{
    /// <summary>
    /// Physics system with gravity reduction.
    /// </summary>
    public sealed class ProceduralPlanetPhysics29 : MonoBehaviour
    {
        [Header("Settings")]
        [SerializeField] float gravityStrength = 9.81f;
        [SerializeField] float reductionFactor = 0.8f;
        ...
        void ApplyReducedGravity()
        {
            ...
            foreach (var body in bodies)
            {
                ...
                float gravity = gravityStrength * (planet.Radius / distance) * reductionFactor;
