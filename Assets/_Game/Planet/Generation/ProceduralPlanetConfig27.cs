...
{
    /// <summary>
    /// Configuration with centering parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Procedural Planet Config 27")]
    public sealed class ProceduralPlanetConfig27 : ScriptableObject
    {
        [Header("Planet")]
        ...
        public Mesh GenerateMesh()
        {
            ...
            var mesh = new Mesh { name = $"{planetName}_Centered" };
