...
{
    /// <summary>
    /// Configuration with compression parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Procedural Planet Config 13")]
    public sealed class ProceduralPlanetConfig13 : ScriptableObject
    {
        [Header("Planet")]
        ...
        /// <summary>
        /// Generate compressed mesh from config.
        /// </summary>
        public Mesh GenerateMesh()
        {
            ...
            var mesh = new Mesh { name = $"{planetName}_Compressed" };
