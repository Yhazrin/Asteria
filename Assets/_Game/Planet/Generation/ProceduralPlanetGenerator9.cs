...
{
    /// <summary>
    /// Planet generator with procedural tangents.
    /// </summary>
    public sealed class ProceduralPlanetGenerator9 : MonoBehaviour
    {
        [Header("Settings")]
        ...
        /// </summary>
        public Mesh GenerateMeshWithTangents()
        {
            ...
            var mesh = new Mesh { name = "PlanetTangents" };
