...
{
    /// <summary>
    /// Physics system with gravity normalization.
    /// </summary>
    public sealed class ProceduralPlanetPhysics34 : MonoBehaviour
    {
        [Header("Settings")]
        ...
        void ApplyNormalizedGravity()
        {
            ...
            foreach (var body in bodies)
            {
                ...
                gravity = Mathf.Min(gravity, maxGravity);
