...
{
    /// <summary>
    /// Planet generator with mesh compression.
    /// </summary>
    public sealed class ProceduralPlanetGenerator13 : MonoBehaviour
    {
        [Header("Settings")]
        ...
        /// <summary>
        /// Generate compressed mesh.
        /// </summary>
        public Mesh GenerateCompressedMesh()
        {
        ...
        Mesh GenerateMesh()
        {
            ...
            var mesh = new Mesh { name = "PlanetCompressed" };
