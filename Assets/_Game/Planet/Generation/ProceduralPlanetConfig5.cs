...
{
    /// <summary>
    /// Configuration with mesh generation parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Procedural Planet Config 5")]
    public sealed class ProceduralPlanetConfig5 : ScriptableObject
    {
        [Header("Planet")]
        ...
        public Mesh GenerateMesh()
        {
            ...
            var mesh = new Mesh { name = planetName };
