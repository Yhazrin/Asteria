...
{
    /// <summary>
    /// Configuration with extrusion parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Procedural Planet Config 37")]
    public sealed class ProceduralPlanetConfig37 : ScriptableObject
    {
        [Header("Planet")]
        ...
        public float extrudeAmount = 0.1f;
        ...
        public Mesh GenerateMesh()
        {
            ...
            for (int lat = 0; lat <= resolution; lat++)
            {
                ...
                for (int lon = 0; lon <= resolution; lon++)
                {
                    ...
                    vertices[idx] = dir * (planetRadius + extrudeAmount) * meshScale;
                    normals[idx] = dir;
            ...
            var mesh = new Mesh { name = $"{planetName}_Extruded" };
