...
{
    /// <summary>
    /// Planet generator with mesh simplification.
    /// </summary>
    public sealed class ProceduralPlanetGenerator15 : MonoBehaviour
    {
        [Header("Settings")]
        [SerializeField] float planetRadius = 300f;
        [SerializeField] int seed = 42;
        [SerializeField] int resolution = 128;
        [SerializeField] float simplificationFactor = 0.5f;
        ...
        Mesh GenerateMesh(int res)
        {
            ...
            var mesh = new Mesh { name = $"Planet_Simplified_{res}" };
