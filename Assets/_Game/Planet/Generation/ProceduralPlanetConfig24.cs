...
{
    /// <summary>
    /// Configuration with subdivision parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Procedural Planet Config 24")]
    public sealed class ProceduralPlanetConfig24 : ScriptableObject
    {
        [Header("Planet")]
        ...
        public Mesh GenerateMesh()
        {
            ...
            var mesh = new Mesh { name = $"{planetName}_Subdivided" };
