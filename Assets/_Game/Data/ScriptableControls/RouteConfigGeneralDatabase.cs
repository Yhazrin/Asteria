...
{
    /// <summary>
    /// General route configuration database for the game.
    /// Contains all route parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Route Config General Database")]
    public sealed class RouteConfigGeneralDatabase : ScriptableObject
    {
        [Header("Routes")]
