...
{
    /// <summary>
    /// Gravity configuration file database for the game.
    /// Contains all gravity parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Gravity Config File Database")]
    public sealed class GravityConfigFileDatabase : ScriptableObject
    {
        [Header("Gravity")]
