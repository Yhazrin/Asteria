...
{
    /// <summary>
    /// Color scheme file database for the game.
    /// Contains all color scheme parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Color Scheme File Database")]
    public sealed class ColorSchemeFileDatabase : ScriptableObject
    {
