...
{
    /// <summary>
    /// Mini-map configuration database for the game.
    /// Contains all mini-map parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/MiniMap Config Database")]
    public sealed class MiniMapConfigDatabase : ScriptableObject
    {
        [Header("MiniMap")]
