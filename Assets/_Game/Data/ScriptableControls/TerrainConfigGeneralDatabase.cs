...
{
    /// <summary>
    /// General terrain configuration database for the game.
    /// Contains all terrain parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Terrain Config General Database")]
    public sealed class TerrainConfigGeneralDatabase : ScriptableObject
    {
        [Header("Noise")]
