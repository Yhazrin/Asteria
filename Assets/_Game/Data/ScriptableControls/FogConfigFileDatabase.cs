...
{
    /// <summary>
    /// Fog configuration file database for the game.
    /// Contains all fog parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Fog Config File Database")]
    public sealed class FogConfigFileDatabase : ScriptableObject
    {
        [Header("Fog")]
