...
{
    /// <summary>
    /// General pressure configuration database for the game.
    /// Contains all pressure parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Pressure Config General Database")]
    public sealed class PressureConfigGeneralDatabase : ScriptableObject
    {
        [Header("Timing")]
