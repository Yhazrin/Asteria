...
{
    /// <summary>
    /// General star configuration database for the game.
    /// Contains all star parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Star Config General Database")]
    public sealed class StarConfigGeneralDatabase : ScriptableObject
    {
        [Header("Stars")]
