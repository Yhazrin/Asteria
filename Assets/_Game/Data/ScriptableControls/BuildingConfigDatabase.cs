...
{
    /// <summary>
    /// Building configuration database for the game.
    /// Contains all building parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Building Config Database")]
    public sealed class BuildingConfigDatabase : ScriptableObject
    {
        [Header("Anchors")]
