...
{
    /// <summary>
    /// Waypoint configuration database for the game.
    /// Contains all waypoint parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Waypoint Config Database")]
    public sealed class WaypointConfigDatabase : ScriptableObject
    {
        [Header("Waypoints")]
