...
{
    /// <summary>
    /// Cloud configuration database for the game.
    /// Contains all cloud parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Cloud Config Database")]
    public sealed class CloudConfigDatabase : ScriptableObject
    {
        [Header("Clouds")]
