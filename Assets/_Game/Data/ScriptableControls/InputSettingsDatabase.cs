...
{
    /// <summary>
    /// Input settings configuration database for the game.
    /// Contains all input parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Input Settings Database")]
    public sealed class InputSettingsDatabase : ScriptableObject
    {
        [Header("Mouse")]
