...
{
    /// <summary>
    /// General animation configuration database for the game.
    /// Contains all animation parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Animation Config General Database")]
    public sealed class AnimationConfigGeneralDatabase : ScriptableObject
    {
        [Header("Character")]
