...
{
    /// <summary>
    /// General wish configuration database for the game.
    /// Contains all wish parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Wish Config General Database")]
    public sealed class WishConfigGeneralDatabase : ScriptableObject
    {
        [Header("Wishes")]
