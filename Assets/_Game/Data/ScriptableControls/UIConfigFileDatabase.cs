...
{
    /// <summary>
    /// UI configuration file database for the game.
    /// Contains all UI parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/UI Config File Database")]
    public sealed class UIConfigFileDatabase : ScriptableObject
    {
        [Header("Canvas")]
