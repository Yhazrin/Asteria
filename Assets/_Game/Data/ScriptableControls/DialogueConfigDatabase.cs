...
{
    /// <summary>
    /// Dialogue configuration database for the game.
    /// Contains all dialogue parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Dialogue Config Database")]
    public sealed class DialogueConfigDatabase : ScriptableObject
    {
        [Header("Dialogue")]
