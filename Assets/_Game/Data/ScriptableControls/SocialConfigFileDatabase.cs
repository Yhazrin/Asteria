...
{
    /// <summary>
    /// Social configuration file database for the game.
    /// Contains all social parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Social Config File Database")]
    public sealed class SocialConfigFileDatabase : ScriptableObject
    {
