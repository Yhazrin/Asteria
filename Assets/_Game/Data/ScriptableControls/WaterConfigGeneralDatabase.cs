...
{
    /// <summary>
    /// General water configuration database for the game.
    /// Contains all water parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Water Config General Database")]
    public sealed class WaterConfigGeneralDatabase : ScriptableObject
    {
        [Header("Water")]
