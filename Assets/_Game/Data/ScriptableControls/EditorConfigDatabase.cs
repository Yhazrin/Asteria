...
{
    /// <summary>
    /// Editor configuration database for the game.
    /// Contains all editor parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Editor Config Database")]
    public sealed class EditorConfigDatabase : ScriptableObject
    {
        [Header("Editor")]
