...
{
    /// <summary>
    /// General shader database for the game.
    /// Contains all shader references.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Shader General Database")]
    public sealed class ShaderGeneralDatabase : ScriptableObject
    {
        [Header("URP Shaders")]
