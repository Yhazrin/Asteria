...
{
    /// <summary>
    /// Physics configuration database for the game.
    /// Contains all physics parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Physics Config Database")]
    public sealed class PhysicsConfigDatabase : ScriptableObject
    {
        [Header("Gravity")]
