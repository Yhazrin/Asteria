...
{
    /// <summary>
    /// Vegetation configuration database for the game.
    /// Contains all vegetation parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Vegetation Config Database")]
    public sealed class VegetationConfigDatabase : ScriptableObject
    {
        [Header("Trees")]
