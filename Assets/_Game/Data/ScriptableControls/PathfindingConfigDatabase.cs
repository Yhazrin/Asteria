...
{
    /// <summary>
    /// Pathfinding configuration database for the game.
    /// Contains all pathfinding parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Pathfinding Config Database")]
    public sealed class PathfindingConfigDatabase : ScriptableObject
    {
        [Header("Pathfinding")]
