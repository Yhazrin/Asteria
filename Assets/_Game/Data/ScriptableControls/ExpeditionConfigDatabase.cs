...
{
    /// <summary>
    /// Expedition configuration database for the game.
    /// Contains all expedition parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Expedition Config Database")]
    public sealed class ExpeditionConfigDatabase : ScriptableObject
    {
        [Header("Expedition")]
