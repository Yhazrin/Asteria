...
{
    /// <summary>
    /// General border database for the game.
    /// Contains all border parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Border General Database")]
    public sealed class BorderGeneralDatabase : ScriptableObject
    {
