...
{
    /// <summary>
    /// General interaction configuration database for the game.
    /// Contains all interaction parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Interaction Config General Database")]
    public sealed class InteractionConfigGeneralDatabase : ScriptableObject
    {
        [Header("Detection")]
