...
{
    /// <summary>
    /// Color scheme configuration database for the game.
    /// Contains all color scheme parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Color Scheme Database")]
    public sealed class ColorSchemeDatabase : ScriptableObject
    {
        ...
        public Color neutralLightest = new(0.95f, 0.95f, 0.95f);
        public Color neutralLight = new(0.8f, 0.8f, 0.8f);
        public Color neutralMedium = new(0.5f, 0.5f, 0.5f);
        public Color neutralDark = new(0.3f, 0.3f, 0.3f);
        public Color neutralDarkest = new(0.1f, 0.1f, 0.1f);
    }
}
