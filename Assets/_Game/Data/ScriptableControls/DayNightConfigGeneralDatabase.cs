...
{
    /// <summary>
    /// General day/night cycle configuration database for the game.
    /// Contains all day/night parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Day Night Config General Database")]
    public sealed class DayNightConfigGeneralDatabase : ScriptableObject
    {
