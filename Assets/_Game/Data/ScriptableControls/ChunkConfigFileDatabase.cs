...
{
    /// <summary>
    /// Chunk configuration file database for the game.
    /// Contains all chunk parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Chunk Config File Database")]
    public sealed class ChunkConfigFileDatabase : ScriptableObject
    {
