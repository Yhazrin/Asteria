...
{
    /// <summary>
    /// Photo mode configuration database for the game.
    /// Contains all photo mode parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Photo Mode Config Database")]
    public sealed class PhotoModeConfigDatabase : ScriptableObject
    {
        [Header("Camera")]
