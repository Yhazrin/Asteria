...
{
    /// <summary>
    /// General texture database for the game.
    /// Contains all texture references.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Texture General Database")]
    public sealed class TextureGeneralDatabase : ScriptableObject
    {
        [Header("Terrain")]
