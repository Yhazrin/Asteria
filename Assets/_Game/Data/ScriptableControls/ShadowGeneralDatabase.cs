...
{
    /// <summary>
    /// General shadow database for the game.
    /// Contains all shadow parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Shadow General Database")]
    public sealed class ShadowGeneralDatabase : ScriptableObject
    {
        [Header("Shadows")]
