...
{
    /// <summary>
    /// Star configuration file database for the game.
    /// Contains all star parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Star Config File Database")]
    public sealed class StarConfigFileDatabase : ScriptableObject
    {
        [Header("Stars")]
