...
{
    /// <summary>
    /// Input settings file database for the game.
    /// Contains all input parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Input Settings File Database")]
    public sealed class InputSettingsFileDatabase : ScriptableObject
    {
        [Header("Mouse")]
