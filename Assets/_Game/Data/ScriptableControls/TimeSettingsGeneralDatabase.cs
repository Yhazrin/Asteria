...
{
    /// <summary>
    /// General time settings database for the game.
    /// Contains all Unity Time settings.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Time Settings General Database")]
    public sealed class TimeSettingsGeneralDatabase : ScriptableObject
    {
        [Header("Time")]
