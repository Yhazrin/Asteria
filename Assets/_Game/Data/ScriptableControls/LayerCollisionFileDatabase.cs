...
{
    /// <summary>
    /// Layer collision file database for the game.
    /// Contains all layer collision matrix settings.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Layer Collision File Database")]
    public sealed class LayerCollisionFileDatabase : ScriptableObject
    {
