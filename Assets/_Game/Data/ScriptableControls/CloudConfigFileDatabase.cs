...
{
    /// <summary>
    /// Cloud configuration file database for the game.
    /// Contains all cloud parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Cloud Config File Database")]
    public sealed class CloudConfigFileDatabase : ScriptableObject
    {
        [Header("Clouds")]
