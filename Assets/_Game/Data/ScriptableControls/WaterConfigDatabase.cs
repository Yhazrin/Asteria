...
{
    /// <summary>
    /// Water configuration database for the game.
    /// Contains all water parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Water Config Database")]
    public sealed class WaterConfigDatabase : ScriptableObject
    {
        [Header("Water")]
