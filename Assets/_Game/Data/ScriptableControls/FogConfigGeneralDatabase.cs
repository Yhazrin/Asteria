...
{
    /// <summary>
    /// General fog configuration database for the game.
    /// Contains all fog parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Fog Config General Database")]
    public sealed class FogConfigGeneralDatabase : ScriptableObject
    {
        [Header("Fog")]
