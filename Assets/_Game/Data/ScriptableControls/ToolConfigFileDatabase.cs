...
{
    /// <summary>
    /// Tool configuration file database for the game.
    /// Contains all tool parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Tool Config File Database")]
    public sealed class ToolConfigFileDatabase : ScriptableObject
    {
        [Header("General")]
