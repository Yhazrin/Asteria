...
{
    /// <summary>
    /// General social configuration database for the game.
    /// Contains all social parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Social Config General Database")]
    public sealed class SocialConfigGeneralDatabase : ScriptableObject
    {
