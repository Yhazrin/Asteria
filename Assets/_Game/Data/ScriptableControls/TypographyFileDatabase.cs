...
{
    /// <summary>
    /// Typography file database for the game.
    /// Contains all typography parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Typography File Database")]
    public sealed class TypographyFileDatabase : ScriptableObject
    {
        [Header("Font Sizes")]
