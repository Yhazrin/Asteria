...
{
    /// <summary>
    /// Particle system configuration database for the game.
    /// Contains all particle parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Particle Database")]
    public sealed class ParticleDatabase : ScriptableObject
    {
