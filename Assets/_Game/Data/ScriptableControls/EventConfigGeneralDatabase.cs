...
{
    /// <summary>
    /// General event configuration database for the game.
    /// Contains all event parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Event Config General Database")]
    public sealed class EventConfigGeneralDatabase : ScriptableObject
    {
