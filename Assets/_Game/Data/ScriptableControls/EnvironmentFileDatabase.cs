...
{
    /// <summary>
    /// Environment file database for the game.
    /// Contains all environment parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Environment File Database")]
    public sealed class EnvironmentFileDatabase : ScriptableObject
    {
        [Header("Sky")]
