...
{
    /// <summary>
    /// General codex configuration database for the game.
    /// Contains all codex parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Codex Config General Database")]
    public sealed class CodexConfigGeneralDatabase : ScriptableObject
    {
        [Header("Codex")]
