...
{
    /// <summary>
    /// LOD configuration file database for the game.
    /// Contains all LOD parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/LOD Config File Database")]
    public sealed class LODConfigFileDatabase : ScriptableObject
    {
        [Header("LOD Settings")]
