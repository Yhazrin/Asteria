...
{
    /// <summary>
    /// Audio settings configuration database for the game.
    /// Contains all Unity AudioSettings parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Audio Settings Config Database")]
    public sealed class AudioSettingsConfigDatabase : ScriptableObject
    {
        [Header("Audio")]
        public int outputSampleRate = 44100;
        public int dspBufferSize = 1024;
        public string speakerMode = "Stereo"; // Stereo, Quad, Surround, etc.
