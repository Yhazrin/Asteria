...
{
    /// <summary>
    /// Creature configuration database for the game.
    /// Contains all creature parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Creature Config Database")]
    public sealed class CreatureConfigDatabase : ScriptableObject
    {
        [Header("Spawning")]
