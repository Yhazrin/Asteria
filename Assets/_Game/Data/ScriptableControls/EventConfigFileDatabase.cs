...
{
    /// <summary>
    /// Event configuration file database for the game.
    /// Contains all event parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Event Config File Database")]
    public sealed class EventConfigFileDatabase : ScriptableObject
    {
