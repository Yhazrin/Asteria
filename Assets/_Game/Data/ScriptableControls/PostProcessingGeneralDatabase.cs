...
{
    /// <summary>
    /// General post-processing database for the game.
    /// Contains all post-processing parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Post Processing General Database")]
    public sealed class PostProcessingGeneralDatabase : ScriptableObject
    {
        [Header("Bloom")]
