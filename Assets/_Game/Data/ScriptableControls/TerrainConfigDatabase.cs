...
{
    /// <summary>
    /// Terrain configuration database for the game.
    /// Contains all terrain parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Terrain Config Database")]
    public sealed class TerrainConfigDatabase : ScriptableObject
    {
        [Header("Noise")]
