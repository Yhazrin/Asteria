...
{
    /// <summary>
    /// General audio settings database for the game.
    /// Contains all Unity AudioSettings parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Audio Settings General Database")]
    public sealed class AudioSettingsGeneralDatabase : ScriptableObject
    {
        [Header("Audio")]
