...
{
    /// <summary>
    /// Interaction configuration database for the game.
    /// Contains all interaction parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Interaction Config Database")]
    public sealed class InteractionConfigDatabase : ScriptableObject
    {
        [Header("Detection")]
