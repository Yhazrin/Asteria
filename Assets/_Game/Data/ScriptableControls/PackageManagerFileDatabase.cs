...
{
    /// <summary>
    /// Package manager file database for the game.
    /// Contains all package references.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Package Manager File Database")]
    public sealed class PackageManagerFileDatabase : ScriptableObject
    {
