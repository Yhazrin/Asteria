...
{
    /// <summary>
    /// Resident configuration file database for the game.
    /// Contains all resident parameters.
    /// </summary>
    [CreateAssetMenu(menuName = "Asteria/Resident Config File Database")]
    public sealed class ResidentConfigFileDatabase : ScriptableObject
    {
        [Header("Movement")]
